        ...
        <div className="lg:ml-72">
          ...
          <div className="lg:py-8 py-8 lg:pr-20 px-5 text-white-100 lg:block hidden">
            <div className="flex justify-between items-center">
              ...
              {account ? (
                <button
                  onClick={() => disconnect()}
                  className="font-montserat font-semibold text-lg border border-yellow-100 hover:bg-yellow-100 rounded-lg py-3 px-6"
                >
          ...
          <div className="lg:py-12 py-8 lg:pr-20 px-5 lg:mt-0 mt-8">
            ...
            <p className="font-montserat font-bold py-2 text-white-100 lg:text-right">
              ...
              <span className="text-yellow-100">85137</span> tickets have been
              sold today!
            </p>
            ...
            <div data-aos="zoom-in" className="bg-gray-50 rounded-2xl p-5 mt-8">
              <div className="flex flex-wrap gap-x-8 items-center space-y-3">
                ...
                <input
                  ...
                  className="bg-black-100 placeholder:text-center rounded-sm placeholder:text-black-50 ring-0 focus:ring-0"
                />
                ...
                <div className="flex flex-wrap items-center">
                  ...
                  >
                    <g filter="url(#filter0_d_1_934)">
                      <path
                        d="M49.8312 49.2885C58.3721 40.4478 58.1292 26.3572 49.2885 17.8162C40.4478 9.27526 26.3572 9.51821 17.8163 18.3589C9.2753 27.1996 9.51826 41.2902 18.3589 49.8311C27.1996 58.3721 41.2902 58.1291 49.8312 49.2885Z"
                        fill="#EC7525"
                      />
                      <path
                        d="M49.0801 18.032C57.8016 26.4578 58.0413 40.3585 49.6154 49.08C41.1896 57.8015 27.2889 58.0412 18.5674 49.6154C9.84586 41.1895 9.60618 27.2888 18.032 18.5673C26.4579 9.84582 40.3586 9.60614 49.0801 18.032Z"
                        stroke="#979797"
                        strokeOpacity="0.8"
                        strokeWidth="0.6"
                      />
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          ...
                          result="effect1_dropShadow_1_934"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_1_934"
                          result="shape"
                        />
                      </filter>
                    </defs>
                  ...
                  >
                    <g filter="url(#filter0_d_1_927)">
                      <path
                        d="M50.2509 49.2885C58.7919 40.4478 58.549 26.3572 49.7083 17.8162C40.8676 9.27526 26.777 9.51821 18.236 18.3589C9.69508 27.1996 9.93803 41.2902 18.7787 49.8311C27.6194 58.3721 41.71 58.1291 50.2509 49.2885Z"
                        fill="#73BDC6"
                      />
                      <path
                        d="M49.4998 18.032C58.2214 26.4578 58.461 40.3585 50.0352 49.08C41.6093 57.8015 27.7087 58.0412 18.9871 49.6154C10.2656 41.1895 10.026 27.2888 18.4518 18.5673C26.8777 9.84582 40.7783 9.60614 49.4998 18.032Z"
                        stroke="#979797"
                        strokeOpacity="0.8"
                        strokeWidth="0.6"
                      />
                    ...
                    <path
                      d="M43.3149 43.1615C48.4712 38.1529 48.5909 29.9126 43.5823 24.7563C38.5737 19.6001 30.3334 19.4804 25.1772 24.489C20.0209 29.4976 19.9012 37.7379 24.9098 42.8941C29.9184 48.0504 38.1587 48.1701 43.3149 43.1615Z"
                      fill="#F7F5DD"
                    />
                    <path
                      d="M31.0126 41.2759L26.8733 41.2435L30.6117 31.1364L26.158 31.1016L26.1796 27.6115L34.8663 27.6874L34.8534 29.7287L31.0185 41.2843L31.0126 41.2759Z"
                      fill="#377279"
                    />
                    <path
                      d="M43.958 31.6776C43.9408 34.4872 42.7621 35.8389 40.6804 38.2084L43.964 38.234L43.9428 41.3726L35.8543 41.3108L35.6882 39.0705C38.2127 36.4616 40.1862 34.3447 40.1977 32.4423C40.1986 31.6514 39.7826 31.119 38.9697 31.1194C38.1141 31.1126 37.3792 31.434 36.0518 32.0132L35.3708 28.6083C36.8954 27.8138 38.0183 27.4927 39.6785 27.5049C42.472 27.5275 43.9692 29.0354 43.9556 31.6919L43.958 31.6776Z"
                      fill="#377279"
                    />
                    <defs>
                      <filter
                      ...
                      >
                        ...
                        <feBlend
                          mode="normal"
                          in2="BackgroundImageFix"
                          result="effect1_dropShadow_1_927"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_1_927"
                          result="shape"
                        />
                      </filter>
                    </defs>
                  ...
                  >
                    <g filter="url(#filter0_d_1_920)">
                      <path
                        d="M50.2508 49.2885C58.7918 40.4478 58.5488 26.3572 49.7081 17.8162C40.8675 9.27526 26.7769 9.51821 18.2359 18.3589C9.69493 27.1996 9.93788 41.2902 18.7786 49.8311C27.6192 58.3721 41.7098 58.1291 50.2508 49.2885Z"
                        fill="#203351"
                      />
                      <path
                        d="M49.4997 18.032C58.2212 26.4578 58.4609 40.3585 50.035 49.08C41.6092 57.8015 27.7085 58.0412 18.987 49.6154C10.2655 41.1895 10.0258 27.2888 18.4517 18.5673C26.8775 9.84582 40.7782 9.60614 49.4997 18.032Z"
                        stroke="#979797"
                        strokeOpacity="0.8"
                        strokeWidth="0.6"
                      />
                    ...
                    <path
                      d="M43.3148 43.1615C48.4711 38.1529 48.5908 29.9126 43.5821 24.7563C38.5735 19.6001 30.3333 19.4804 25.177 24.489C20.0207 29.4976 19.901 37.7379 24.9097 42.8941C29.9183 48.0504 38.1585 48.1701 43.3148 43.1615Z"
                      fill="#F7F5DD"
                    />
                    <path
                      d="M27.4259 41.2102L27.4911 30.3268L25.7884 30.3114L25.8026 27.8378L28.2198 26.5917L31.461 26.6181L31.3815 41.2405L27.4348 41.2038L27.4259 41.2102Z"
                      fill="#3D5985"
                    />
                    <path
                      d="M42.3401 30.911C42.3215 33.9262 41.0566 35.3767 38.8226 37.9196L42.3465 37.9471L42.3237 41.3153L33.6433 41.249L33.4651 38.8448C36.1744 36.045 38.2922 33.7732 38.3135 31.7252C38.3144 30.8765 37.868 30.3051 36.9956 30.3056C36.0774 30.2983 35.2887 30.6432 33.8642 31.2648L33.127 27.6018C34.7631 26.7491 35.9683 26.4045 37.75 26.4177C40.7479 26.4418 42.3546 28.0601 42.3401 30.911Z"
                      fill="#3D5985"
                    />
                    <defs>
                      <filter
                      ...
                      >
                        ...
                        <feBlend
                          mode="normal"
                          in2="BackgroundImageFix"
                          result="effect1_dropShadow_1_920"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_1_920"
                          result="shape"
                        />
                      </filter>
                    </defs>
                  ...
                  >
                    <g filter="url(#filter0_d_1_915)">
                      <path
                        d="M50.2509 49.2885C58.7919 40.4478 58.5489 26.3572 49.7082 17.8162C40.8676 9.27526 26.777 9.51821 18.236 18.3589C9.69502 27.1996 9.93797 41.2902 18.7786 49.8311C27.6193 58.3721 41.7099 58.1291 50.2509 49.2885Z"
                        fill="#82C83D"
                      />
                      <path
                        d="M49.4998 18.032C58.2213 26.4578 58.461 40.3585 50.0351 49.08C41.6093 57.8015 27.7086 58.0412 18.9871 49.6154C10.2656 41.1895 10.0259 27.2888 18.4517 18.5673C26.8776 9.84582 40.7783 9.60614 49.4998 18.032Z"
                        stroke="#979797"
                        strokeOpacity="0.8"
                        strokeWidth="0.6"
                      />
                    ...
                    <path
                      d="M43.3149 43.1615C48.4712 38.1529 48.5908 29.9126 43.5822 24.7563C38.5736 19.6001 30.3334 19.4804 25.1771 24.489C20.0208 29.4976 19.9011 37.7379 24.9097 42.8941C29.9184 48.0504 38.1586 48.1701 43.3149 43.1615Z"
                      fill="#F7F5DD"
                    />
                    <path
                      d="M39.5548 36.8109C39.5287 40.5014 37.9608 42.834 33.9166 42.8008C29.8546 42.7646 27.8664 40.0989 27.8895 35.1763C27.9235 28.3396 31.133 25.2471 38.2724 25.3157L37.9814 29.2256C34.9852 29.1979 33.3349 29.7921 32.6601 31.9122L32.7102 32.0485C33.3667 31.832 34.168 31.7316 34.9692 31.7405C37.7924 31.7661 39.5763 33.3112 39.5548 36.8109ZM32.5069 35.4897C32.4786 35.713 32.4473 35.954 32.4515 36.201C32.4362 37.9775 32.849 38.9967 34.0064 39.0026C34.9169 39.012 35.2915 38.4646 35.3107 37.1541C35.3209 35.8969 34.9431 35.3215 33.8419 35.307C33.3763 35.3096 32.986 35.3525 32.5247 35.4927L32.5069 35.4897Z"
                      fill="#315111"
                    />
                    <defs>
                      <filter
                      ...
                      >
                        ...
                        <feBlend
                          mode="normal"
                          in2="BackgroundImageFix"
                          result="effect1_dropShadow_1_915"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_1_915"
                          result="shape"
                        />
                      </filter>
                    </defs>
                  ...
                  >
                    <g filter="url(#filter0_d_1_910)">
                      <path
                        d="M50.251 49.2885C58.7919 40.4478 58.549 26.3572 49.7083 17.8162C40.8677 9.27526 26.777 9.51821 18.2361 18.3589C9.69511 27.1996 9.93807 41.2902 18.7787 49.8311C27.6194 58.3721 41.71 58.1291 50.251 49.2885Z"
                        fill="#1D82DD"
                      />
                      <path
                        d="M49.4999 18.032C58.2214 26.4578 58.4611 40.3585 50.0352 49.08C41.6094 57.8015 27.7087 58.0412 18.9872 49.6154C10.2657 41.1895 10.026 27.2888 18.4518 18.5673C26.8777 9.84582 40.7784 9.60614 49.4999 18.032Z"
                        stroke="#979797"
                        strokeOpacity="0.8"
                        strokeWidth="0.6"
                      />
                    ...
                    <path
                      d="M43.315 43.1615C48.4712 38.1529 48.5909 29.9126 43.5823 24.7563C38.5737 19.6001 30.3334 19.4804 25.1772 24.489C20.0209 29.4976 19.9012 37.7379 24.9098 42.8941C29.9185 48.0504 38.1587 48.1701 43.315 43.1615Z"
                      fill="#F7F5DD"
                    />
                    <path
                      d="M39.2012 30.586C39.182 33.6982 37.8764 35.1955 35.5771 37.8294L39.2143 37.8577L39.1909 41.3343L30.2312 41.2659L30.0472 38.7844C32.8437 35.8945 35.0296 33.5495 35.0517 31.4357C35.0526 30.5597 34.5918 29.9699 33.6914 29.9704C32.7436 29.9629 31.9296 30.3189 30.4592 30.9605L29.6983 27.1797C31.3871 26.2995 32.631 25.9438 34.47 25.9574C37.5643 25.9824 39.2228 27.6527 39.2078 30.5953L39.2012 30.586Z"
                      fill="#1A578E"
                    />
                    <defs>
                      <filter
                      ...
                      >
                        ...
                        <feBlend
                          mode="normal"
                          in2="BackgroundImageFix"
                          result="effect1_dropShadow_1_910"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_1_910"
                          result="shape"
                        />
                      </filter>
                    </defs>
              ...
              <div className="bg-black-100 p-5 rounded-2xl">
                <div className="flex flex-wrap justify-between items-center">
                  ...
                  <p className="font-montserat font-semibold text-lg text-black-50 ">
                    ...
                    <span className="text-white-100">10909</span>
                  </p>
                </div>
          ...
          <div className="lg:py-12 py-8 lg:pr-20 px-5">
            ...
            >
              <div className="bg h-full w-full p-16 space-y-6">
                <img src={play_1} alt="Logo" className="flex mx-auto w-48" />

                <h2 className="text-center font-extrabold tracking-wide text-2xl">
                  BUY TICKETS
                </h2>

                <p className="tracking-wide text-center leading-snug uppercase lg:w-full sm:w-1/2 flex mx-auto">
                  Buy ticket with $0.1, and choose numbers for ticket.
                </p>
              </div>

              <div className="bg h-full w-full p-16 space-y-6">
                <img src={play_2} alt="Logo" className="flex mx-auto w-48" />
              ...
              <div className="bg h-full w-full xs:p-16 p-8 space-y-6">
                <img src={play_3} alt="Logo" className="flex mx-auto w-48" />
          ...
          <div className="lg:py-12 py-8 lg:pr-20 px-5">
            ...
            <div data-aos="zoom-in" className="bg-gray-50 rounded-2xl p-6 mt-8">
              ...
              <div className="py-8 text-white-100 font-montserat lg:w-10/12">
                ...
                <p>
                  ...
                  Prizes are drawn at 15:00 UTC+0 every day. You can buy a
                  ticket for 5 TCEO. The sale of tickets stops at 14:55 UTC+0
                  every day. The player chooses six numbers for each ticket, the
                  first five are from 1 to 36, and the last one is from 1 to 10.
                </p>
                <p className="pt-3">
                  You can choose numbers manually or automatically. If you have
                  BCL, you can use BCL to redeem Tickets. Each draw produces six
                  numbers. The more numbers you match in the first five numbers,
              ...
              <div className="pb-8 text-white-100 font-montserat lg:w-10/12">
                ...
                <p>
                  ...
                  the only winner, you may need to share the prize equally with
                  others. Five numbers matched, and the sixth number is missed:
                  Each ticket gets a $3,000 prize. Four of the first 5 numbers
                  matched: Each ticket gets a $20 prize. Three of the first 5
                  numbers matched: Each ticket gets a $1 prize. If all six
                  numbers are missed, the lottery will be reserved for free, and
                  continue participating in the next day's draw.
                </p>
              </div>
            </div>
          </div>
